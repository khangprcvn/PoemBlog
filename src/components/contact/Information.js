            ...
            <div className="row">
              <div className="col-xl-8 mx-auto">
                ...
                <p className="lead text-center">
                  Trường Đại học Bách khoa là một trường đại học đa ngành về
                  khối ngành kỹ thuật tại Việt Nam, là thành viên của hệ thống
                  Đại học Quốc gia, được xếp vào nhóm trường đại học trọng điểm
                  quốc gia Việt Nam.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="box-simple">
                  ...
                  <p>
                    <strong>(02) 838 654 087</strong>
                  </p>
                  <p>
                    <strong>Số Fax: (02) 838 637 002</strong>
                  </p>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="box-simple">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <strong>
                        <a href="mailto:">pdt@hcmut.edu.vn</a>
                      </strong>
                    </li>
                  </ul>
                </div>
